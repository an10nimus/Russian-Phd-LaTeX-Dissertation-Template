...
\end{equation}
Графики функций $f_1(\gamma) = (a+\gamma)^2$ и $f_2(\gamma) = 4\gamma\ve_\|/\ve_\bot$ представлены на Рис.~\ref{pic:ch5_graph_solver_1}
\begin{figure}\label{pic:ch5_graph_solver_1}
	\centering
	\includegraphics[width=9cm]{ch5_graph_solver_1}
	\caption{Графики функций $f_1(\gamma)$ и $f_2(\gamma)$.}
\end{figure}
